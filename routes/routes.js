...
var userFunction = require('../functions/users');
module.exports = function(app,io) {
	...
	io.on('connection', function(socket){
		...
		socket.emit('update', { message: 'Hello Client',update:true });

  		socket.on('update', function(msg){

    		console.log('this one..',msg);
  		});

  		socket.on('add user',function (data) {
			console.log('user data..',data);
			var userName = data;
			userFunction.userregister(userName,function (result) {
